...
$inputXML = '<Window x:Class="WinUtility.MainWindow"
    ...
    <Window.Resources>
        ...
        <Style TargetType="TabItem">
            <Style.Triggers>
                <!-- Voeg een trigger toe voor de IsSelected-eigenschap (geopend tabblad) -->
                <Trigger Property="IsSelected" Value="True">
                    <!-- Stel de voorgrondkleur in op "StaticResource MainForegroundColor" -->
                    <Setter Property="Foreground" Value="{MainForegroundColor}"/>
                </Trigger>
            </Style.Triggers>
        </Style>
            ...
            <Grid Background="{MainBackgroundColor}" ShowGridLines="False" Name="WPFMainGrid">
                ...
                <DockPanel Background="{MainBackgroundColor}" SnapsToDevicePixels="True" Grid.Row="0" Width="1100">
                    ...
                    <Button Content="Config" HorizontalAlignment="Left" Height="40" Width="100" 
                        Background="{ButtonConfigBackgroundColor}" Foreground="{ButtonInstallForegroundColor}" FontWeight="Bold" Name="WPFTab4BT"/>
                    <Button Content="Updates" HorizontalAlignment="Left" Height="40" Width="100" 
                        Background="{ButtonUpdatesBackgroundColor}" Foreground="{ButtonInstallForegroundColor}" FontWeight="Bold" Name="WPFTab5BT"/>
                </DockPanel>
                    ...
                    <TabItem Header="Install" Visibility="Collapsed" Name="WPFTab1">
                        <Grid Background="#222222">
                            ...
                            <StackPanel Background="{MainBackgroundColor}" SnapsToDevicePixels="True" Grid.Row="1" Grid.Column="1" Margin="10">
                                ...
                                <CheckBox Name="WPFInstallvscode" Content="Visual Studio Code" Margin="5,0"/>
                        ...
                        <Grid Background="#333333">
                            ...
                            <StackPanel Background="{MainBackgroundColor}" SnapsToDevicePixels="True" Grid.Column="1" Margin="10,5">
                                ...
                                <TextBlock Margin="20,0,20,0" Padding="10" TextWrapping="WrapWithOverflow" MaxWidth="300">This is my recommended setting I use on all computers.
                                    <LineBreak/>
                                    <LineBreak/> It will delay feature updates by 2 years and will install security updates 4 days after release.
                                </TextBlock>
                            </StackPanel>
                            <StackPanel Background="{MainBackgroundColor}" SnapsToDevicePixels="True" Grid.Column="2" Margin="10,5">
                                ...
                                <TextBlock Margin="20,0,20,0" Padding="10" TextWrapping="WrapWithOverflow" MaxWidth="300">This completely disables ALL Windows Updates and is NOT RECOMMENDED.
                                    <LineBreak/>
                                    <LineBreak/> However, it can be suitable if you use your system for a select purpose and do not actively browse the internet. .
                                </TextBlock>
...
$sync.configs.applications = '{
  "WPFInstall7zip": {"winget": "7zip.7zip","choco": "7zip"  },
  "WPFInstalladobe": {"winget": "Adobe.Acrobat.Reader.64-bit","choco": "adobereader"  },
  "WPFInstalladvancedip": {"winget": "Famatech.AdvancedIPScanner","choco": "advanced-ip-scanner"  },
  "WPFInstallaudacity": {"winget": "Audacity.Audacity","choco": "audacity"  },
  "WPFInstallautohotkey": {"winget": "AutoHotkey.AutoHotkey","choco": "autohotkey"  },
  "WPFInstallblender": {"winget": "BlenderFoundation.Blender","choco": "blender"  },
  "WPFInstallbrave": {"winget": "Brave.Brave","choco": "brave"  },
  "WPFInstallbulkcrapuninstaller": {"winget": "Klocman.BulkCrapUninstaller","choco": "bulk-crap-uninstaller"  },
  "WPFInstallchrome": {"winget": "Google.Chrome","choco": "googlechrome"  },
  "WPFInstallcpuz": {"winget": "CPUID.CPU-Z","choco": "cpu-z"  },
  "WPFInstallddu": {"winget": "ddu","choco": "ddu"  },
  "WPFInstalldeluge": {"winget": "DelugeTeam.Deluge","choco": "deluge"  },
  "WPFInstalldiscord": {"winget": "Discord.Discord","choco": "discord"  },
  "WPFInstalldockerdesktop": {"winget": "Docker.DockerDesktop","choco": "docker-desktop"  },
  "WPFInstalldotnet3": {"winget": "Microsoft.DotNet.DesktopRuntime.3_1","choco": "dotnetcore3-desktop-runtime"  },
  "WPFInstalldotnet5": {"winget": "Microsoft.DotNet.DesktopRuntime.5","choco": "dotnet-5.0-runtime"  },
  "WPFInstalldotnet6": {"winget": "Microsoft.DotNet.DesktopRuntime.6","choco": "dotnet-6.0-runtime"  },
  "WPFInstalleaapp": {"winget": "ElectronicArts.EADesktop","choco": "ea-app"  },
  "WPFInstalledge": {"winget": "Microsoft.Edge","choco": "microsoft-edge"  },
  "WPFInstallepicgames": {"winget": "EpicGames.EpicGamesLauncher","choco": "epicgameslauncher"  },
  "WPFInstallesearch": {"winget": "voidtools.Everything","choco": "everything"  },
  "WPFInstalletcher": {"winget": "Balena.Etcher","choco": "etcher"  },
  "WPFInstallflameshot": {"winget": "Flameshot.Flameshot","choco": "na"  },
  "WPFInstallflux": {"winget": "flux.flux","choco": "flux"  },
  "WPFInstallfoxpdf": {"winget": "Foxit.PhantomPDF","choco": "na"  },
  "WPFInstallgeforcenow": {"winget": "Nvidia.GeForceNow","choco": "nvidia-geforce-now"  },
  "WPFInstallgimp": {"winget": "GIMP.GIMP","choco": "gimp"  },
  "WPFInstallgit": {"Winget": "Git.Git","choco": "git"  },
  "WPFInstallgithubdesktop": {"winget": "Git.Git;GitHub.GitHubDesktop","choco": "git;github-desktop"  },
  "WPFInstallglaryutilities": {"Winget": "Glarysoft.GlaryUtilities","choco": "glaryutilities-free"  },
  "WPFInstallgog": {"winget": "GOG.Galaxy","choco": "goggalaxy"  },
  "WPFInstallgolang": {"Winget": "GoLang.Go","choco": "golang"  },
  "WPFInstallgpuz": {"winget": "TechPowerUp.GPU-Z","choco": "gpu-z"  },
  "WPFInstallgreenshot": {"winget": "Greenshot.Greenshot","choco": "greenshot"  },
  "WPFInstallgsudo": {"winget": "gerardog.gsudo","choco": "gsudo"  },
  "WPFInstallhandbrake": {"winget": "HandBrake.HandBrake","choco": "handbrake"  },
  "WPFInstallheroiclauncher": {"winget": "HeroicGamesLauncher.HeroicGamesLauncher","choco": "na"  },
  "WPFInstallhwinfo": {"winget": "REALiX.HWiNFO","choco": "hwinfo"  },
  "WPFInstallimageglass": {"winget": "DuongDieuPhap.ImageGlass","choco": "imageglass"  },
  "WPFInstallinkscape": {"winget": "Inkscape.Inkscape","choco": "inkscape"  },
  "WPFInstallitunes": {"winget": "Apple.iTunes","choco": "itunes"  },
  "WPFInstalljava8": {"winget": "EclipseAdoptium.Temurin.8.JRE","choco": "temurin8jre"  },
  "WPFInstalljava11": {"winget": "EclipseAdoptium.Temurin.11.JRE","choco": "javaruntime"  },
  "WPFInstalljava16": {"winget": "AdoptOpenJDK.OpenJDK.16","choco": "temurin16jre"  },
  "WPFInstalljava17": {"winget": "EclipseAdoptium.Temurin.17.JRE","choco": "temurin17jre"  },
  "WPFInstalljava18": {"winget": "EclipseAdoptium.Temurin.18.JRE","choco": "temurin18jre"  },
  "WPFInstalljava19": {"winget": "EclipseAdoptium.Temurin.19.JRE","choco": "temurin19jre"  },
  "WPFInstalljava20": {"winget": "Azul.Zulu.20.JDK","choco": "na"  },
  "WPFInstalljdownloader": {"winget": "AppWork.JDownloader","choco": "jdownloader"  },
  "WPFInstalljetbrains": {"winget": "JetBrains.Toolbox","choco": "jetbrainstoolbox"  },
  "WPFInstalljoplin": {"winget": "Joplin.Joplin","choco": "joplin"  },
  "WPFInstallkeepass": {"winget": "KeePassXCTeam.KeePassXC","choco": "keepassxc"  },
  "WPFInstallkodi": {"winget": "XBMCFoundation.Kodi","choco": "kodi"  },
  "WPFInstallkrita": {"winget": "KDE.Krita","choco": "krita"  },
  "WPFInstalllibreoffice": {"winget": "TheDocumentFoundation.LibreOffice","choco": "libreoffice-fresh"  },
  "WPFInstallmalwarebytes": {"winget": "Malwarebytes.Malwarebytes","choco": "malwarebytes"  },
  "WPFInstallmonitorian": {"winget": "emoacht.Monitorian","choco": "monitorian"  },
  "WPFInstallmpc": {"winget": "clsid2.mpc-hc","choco": "mpc-hc"  },
  "WPFInstallmremoteng": {"winget": "mRemoteNG.mRemoteNG","choco": "mremoteng"  },
  "WPFInstallnanazip": {"winget": "M2Team.NanaZip","choco": "nanazip"  },
  "WPFInstallnano": {"winget": "GNU.Nano","choco": "nano"  },
  "WPFInstallnaps2": {"winget": "Cyanfish.NAPS2","choco": "naps2"  },
  "WPFInstallneovim": {"winget": "Neovim.Neovim","choco": "neovim"  },
  "WPFInstallnodejs": {"winget": "OpenJS.NodeJS","choco": "nodejs"  },
  "WPFInstallnodejslts": {"winget": "OpenJS.NodeJS.LTS","choco": "nodejs-lts"  },
  "WPFInstallnomacs": {"winget": "nomacs.nomacs","choco": "nomacs"  },
  "WPFInstallnotepadplus": {"winget": "Notepad++.Notepad++","choco": "notepadplusplus"  },
  "WPFInstallnuget": {"winget": "Microsoft.NuGet","choco": "nuget.commandline"  },
  "WPFInstallnvclean": {"winget": "TechPowerUp.NVCleanstall","choco": "na"  },
  "WPFInstallnvm": {"winget": "CoreyButler.NVMforWindows","choco": "nvm"  },
  "WPFInstallobs": {"winget": "OBSProject.OBSStudio","choco": "obs-studio"  },
  "WPFInstallobsidian": {"winget": "Obsidian.Obsidian","choco": "obsidian"  },
  "WPFInstallokular": {"winget": "KDE.Okular","choco": "okular"  },
  "WPFInstallonedrive": {"winget": "Microsoft.OneDrive","choco": "onedrive"  },
  "WPFInstallonlyoffice": {"winget": "ONLYOFFICE.DesktopEditors","choco": "onlyoffice"  },
  "WPFInstallopenoffice": {"winget": "Apache.OpenOffice","choco": "openoffice"  },
  "WPFInstallopenshell": {"winget": "Open-Shell.Open-Shell-Menu","choco": "open-shell"  },
  "WPFInstallpeazip": {"winget": "Giorgiotani.Peazip","choco": "peazip"  },
  "WPFInstallpostman": {"winget": "Postman.Postman","choco": "postman"  },
  "WPFInstallpowershell": {"winget": "Microsoft.PowerShell","choco": "powershell-core"  },
  "WPFInstallpowertoys": {"winget": "Microsoft.PowerToys","choco": "powertoys"  },
  "WPFInstallprismlauncher": {"winget": "PrismLauncher.PrismLauncher","choco": "na"  },
  "WPFInstallprocesslasso": {"winget": "BitSum.ProcessLasso","choco": "plasso"  },
  "WPFInstallprocessmonitor": {"winget": "Microsoft.Sysinternals.ProcessMonitor","choco": "procexp"  },
  "WPFInstallputty": {"winget": "PuTTY.PuTTY","choco": "putty"  },
  "WPFInstallpython3": {"winget": "Python.Python.3.11","choco": "python"  },
  "WPFInstallqbittorrent": {"winget": "qBittorrent.qBittorrent","choco": "qbittorrent"  },
  "WPFInstallrevo": {"winget": "RevoUninstaller.RevoUninstaller","choco": "revo-uninstaller"  },
  "WPFInstallrufus": {"winget": "Rufus.Rufus","choco": "rufus"  },
  "WPFInstallrustdesk": {"winget": "RustDesk.RustDesk","choco": "rustdesk.portable"  },
  "WPFInstallrustlang": {"Winget": "Rustlang.Rust.MSVC","choco": "rust"  },
  "WPFInstallsandboxie": {"winget": "Sandboxie.Plus","choco": "sandboxie"  },
  "WPFInstallsdio": {"winget": "GlennDelahoy.SnappyDriverInstallerOrigin","choco": "sdio"  },
  "WPFInstallsharex": {"winget": "ShareX.ShareX","choco": "sharex"  },
  "WPFInstallshell": {"winget": "Nilesoft.Shell","choco": "na"  },
  "WPFInstallsignal": {"winget": "OpenWhisperSystems.Signal","choco": "signal"  },
  "WPFInstallsimplewall": {"Winget": "Henry++.simplewall","choco": "simplewall"  },
  "WPFInstallskype": {"winget": "Microsoft.Skype","choco": "skype"  },
  "WPFInstallslack": {"winget": "SlackTechnologies.Slack","choco": "slack"  },
  "WPFInstallsqlstudio": {"winget": "Microsoft.SQLServerManagementStudio","choco": "sql-server-management-studio"  },
  "WPFInstallsteam": {"winget": "Valve.Steam","choco": "steam-client"  },
  "WPFInstallstrawberry": {"winget": "StrawberryMusicPlayer.Strawberry","choco": "strawberrymusicplayer"  },
  "WPFInstallsublime": {"winget": "SublimeHQ.SublimeText.4","choco": "sublimetext4"  },
  "WPFInstallsumatra": {"winget": "SumatraPDF.SumatraPDF","choco": "sumatrapdf"  },
  "WPFInstalltcpview": {"winget": "Microsoft.Sysinternals.TCPView","choco": "tcpview"  },
  "WPFInstallteams": {"winget": "Microsoft.Teams","choco": "microsoft-teams"  },
  "WPFInstallteamviewer": {"winget": "TeamViewer.TeamViewer","choco": "teamviewer9"  },
  "WPFInstalltelegram": {"winget": "Telegram.TelegramDesktop","choco": "telegram"  },
  "WPFInstallterminal": {"winget": "Microsoft.WindowsTerminal","choco": "microsoft-windows-terminal"  },
  "WPFInstalltor": {"Winget": "TorProject.TorBrowser","choco": "tor-browser"  },
  "WPFInstalltreesize": {"winget": "JAMSoftware.TreeSize.Free","choco": "treesizefree"  },
  "WPFInstallttaskbar": {"winget": "9PF4KZ2VN4W9","choco": "translucenttb"  },
  "WPFInstalltwinkletray": {"Winget": "xanderfrangos.twinkletray","choco": "na"  },
  "WPFInstalltidal": {"Winget": "9NNCB5BS59PH","choco": "na"  },
  "WPFInstallubisoft": {"winget": "Ubisoft.Connect","choco": "ubisoft-connect"  },
  "WPFInstallunity": {"winget": "Unity.UnityHub","choco": "unityhub"  },
  "WPFInstallvc2015_32": {"winget": "Microsoft.VCRedist.2015+.x86","choco": "na"  },
  "WPFInstallvc2015_64": {"winget": "Microsoft.VCRedist.2015+.x64","choco": "na"  },
  "WPFInstallviber": {"Winget": "Viber.Viber","choco": "viber"  },
  "WPFInstallvisualstudio": {"winget": "Microsoft.VisualStudio.2022.Community","choco": "visualstudio2022community"  },
  "WPFInstallvivaldi": {"winget": "VivaldiTechnologies.Vivaldi","choco": "vivaldi"  },
  "WPFInstallvlc": {"winget": "VideoLAN.VLC","choco": "vlc"  },
  "WPFInstallvoicemeeter": {"winget": "VB-Audio.Voicemeeter","choco": "voicemeeter"  },
  "WPFInstallvscode": {"winget": "Git.Git;Microsoft.VisualStudioCode","choco": "vscode"  },
  "WPFInstallvscodium": {"winget": "Git.Git;VSCodium.VSCodium","choco": "vscodium"  },
  "WPFInstallwaterfox": {"winget": "Waterfox.Waterfox","choco": "waterfox"  },
  "WPFInstallwindirstat": {"winget": "WinDirStat.WinDirStat","choco": "windirstat"  },
  "WPFInstallwingetui": {"winget": "SomePythonThings.WingetUIStore","choco": "na"  },
  "WPFInstallwinmerge": {"winget": "WinMerge.WinMerge","choco": "winmerge"  },
  "WPFInstallwinrar": {"winget": "RARLab.WinRAR","choco": "winrar"  },
  "WPFInstallwinscp": {"winget": "WinSCP.WinSCP","choco": "winscp"  },
  "WPFInstallwireshark": {"winget": "WiresharkFoundation.Wireshark","choco": "wireshark"  },
  "WPFInstallwiztree": {"Winget": "AntibodySoftware.WizTree","choco": "wiztree"  },
  "WPFInstallxdm": {"winget": "subhra74.XtremeDownloadManager","choco": "xdm"  },
  "WPFInstallzoom": {"winget":"Zoom.Zoom","choco":"zoom"  }
}' | convertfrom-json
$sync.configs.dns = '{
    "Google":{
        "Primary": "8.8.8.8",
...
$sync.configs.themes = '{
    "Classic":  {
                    ...
                    "ButtonBinBackgroundColor":  "#666666",
    ...
    "Matrix":  {
                   ...
                   "ButtonInstallBackgroundColor":  "#222222",
                   "ButtonTweaksBackgroundColor":  "#444444",
                   "ButtonConfigBackgroundColor":  "#555555",
                   "ButtonUpdatesBackgroundColor":  "#666666",
                   "ButtonBinBackgroundColor":  "#333333",
                   "ButtonInstallForegroundColor":  "#FFFFFF",
